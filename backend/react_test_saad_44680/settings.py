"""
Django settings for react_test_saad_44680 project.
...
ROOT_URLCONF = 'react_test_saad_44680.urls'
...
WSGI_APPLICATION = 'react_test_saad_44680.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "react_test_saad_44680 API",
    "DESCRIPTION": "API documentation for react_test_saad_44680 App",
    "VERSION": "v1",
}
